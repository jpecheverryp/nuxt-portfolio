<template>
  <header class="flex justify-between items-center py-4 m-0 relative">
    <nuxt-link class="text-brand text-xl font-bold" to="/">Juan P Echeverry</nuxt-link>
    <nav
      class="flex flex-col items-end fixed right-0 top-0 bg-brand h-screen w-1/2 p-5 text-right gap-12 translate-x-full transition duration-300 md:relative md:w-auto md:h-auto md:translate-x-0 md:bg-transparent"
      ref="navMenu">
